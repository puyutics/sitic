...
/**
 * NominaSearch represents the model behind the search form of `app\models\parkingcontrol\Nomina`.
 */
class NominaSearch extends Nomina
{
    ...
    {
        return [
            [['NOMINA_ID', 'NOMINA_APE', 'NOMINA_NOM', 'NOMINA_CLAVE', 'NOMINA_TELEFONO', 'NOMINA_SALVOCONDUCTO', 'NOMINA_COD', 'NOMINA_TIPO', 'NOMINA_CAL1', 'NOMINA_AREA1', 'NOMINA_DEP1', 'NOMINA_FING', 'NOMINA_FSAL', 'NOMINA_OBS', 'NOMINA_FINGER', 'NOMINA_F1', 'NOMINA_CED', 'NOMINA_FIR', 'NOMINA_HD1', 'NOMINA_HF1', 'NOMINA_HI1', 'NOMINA_HD2', 'NOMINA_HF2', 'NOMINA_HI2', 'NOMINA_EMPC', 'NOMINA_EMPE', 'NOMINA_DOC', 'NOMINA_PLA', 'NOMINA_CARD', 'NOMINA_FCARD', 'NOMINA_OBS1', 'NOMINA_NOW', 'NOMINA_AUTO', 'NOMINA_TIPOID', 'NOMINA_TIPONOM', 'NOMINA_HS1', 'NOMINA_HS2', 'NOMINA_HWSQ1', 'NOMINA_HWSQ2', 'NOMINA_ISO1', 'NOMINA_ISO2', 'NOMINA_PLACA'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'NOMINA_CONTROLPASADAS' => $this->NOMINA_CONTROLPASADAS,
            'NOMINA_MAXPASADAS' => $this->NOMINA_MAXPASADAS,
            'NOMINA_DESBLOQUEA' => $this->NOMINA_DESBLOQUEA,
            'NOMINA_SYNC' => $this->NOMINA_SYNC,
            'NOMINA_SYNCID' => $this->NOMINA_SYNCID,
            'NOMINA_ORIGEN' => $this->NOMINA_ORIGEN,
        ]);

        $query
            ->andFilterWhere(['=', 'NOMINA_ID', $this->NOMINA_ID])
            ...
            ->andFilterWhere(['like', 'NOMINA_TELEFONO', $this->NOMINA_TELEFONO])
            ->andFilterWhere(['like', 'NOMINA_SALVOCONDUCTO', $this->NOMINA_SALVOCONDUCTO])
            ...
            ->andFilterWhere(['like', 'NOMINA_ISO1', $this->NOMINA_ISO1])
            ->andFilterWhere(['like', 'NOMINA_ISO2', $this->NOMINA_ISO2])
            ->andFilterWhere(['like', 'NOMINA_PLACA', $this->NOMINA_PLACA]);
