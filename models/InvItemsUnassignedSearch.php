...
/**
 * InvItemsUnassignedSearch represents the model behind the search form of `app\models\InvItemsUnassigned`.
 */
class InvItemsUnassignedSearch extends InvItemsUnassigned 
{
    /**
     * @inheritdoc
     */
