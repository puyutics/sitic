...
/**
 * TthhAsistenciaSearch represents the model behind the search form of `app\models\sisges\TthhAsistencia`.
 */
class TthhAsistenciaSearch extends TthhAsistencia
{
    /**
     * {@inheritdoc}
     */
