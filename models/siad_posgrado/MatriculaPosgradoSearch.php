...
use app\models\siad_posgrado\MatriculaPosgrado;

/**
 * MatriculaPosgradoSearch represents the model behind the search form of `app\models\siad_posgrado\MatriculaPosgrado`.
 */
class MatriculaPosgradoSearch extends MatriculaPosgrado
{
    /**
     * {@inheritdoc}
     */
