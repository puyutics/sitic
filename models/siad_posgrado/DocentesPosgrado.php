 ...
 */
class DocentesPosgrado extends \yii\db\ActiveRecord implements IdentityInterface
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(AcademicoDocentePosgrado::className(), ['ciinfper' => 'CIInfPer']);
    }
    ...
    {
        return $this->hasMany(DocenteAsignaturaPosgrado::className(), ['CIInfPer' => 'CIInfPer']);
    }
    ...
    {
        return $this->hasMany(PracticasPreprofPosgrado::className(), ['cedula_tutor' => 'CIInfPer']);
    }
