...
use app\models\siad_posgrado\DocentesPosgrado;

/**
 * DocentesSearch represents the model behind the search form of `app\models\siad_pregrado\Docentes`.
 */
class DocentesPosgradoSearch extends DocentesPosgrado
{
    /**
     * {@inheritdoc}
     */
