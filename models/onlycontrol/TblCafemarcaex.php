...
/**
 * This is the model class for table "TBL_CAFEMARCAEX".
 *
 * @property int $C_CONT
 ...
 */
class TblCafemarcaex extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['C_NOMINA', 'C_TIEMPO', 'C_TIPOUSER', 'C_TIPO', 'C_MENU', 'C_NUM', 'C_COSTO', 'C_TOTAL', 'C_TRANS', 'C_STATUS', 'C_IP'], 'required'],
            [['C_TIEMPO'], 'safe'],
            [['C_NUM', 'C_TRANS', 'C_PLANIFICADO'], 'integer'],
