...
use app\models\eva_posgrado\MdlRoleAssignmentsPosgrado;

/**
 * MdlRoleAssignmentsSearch represents the model behind the search form of `app\models\eva_pregrado\MdlRoleAssignments`.
 */
class MdlRoleAssignmentsPosgradoSearch extends MdlRoleAssignmentsPosgrado
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MdlRoleAssignmentsPosgrado::find();
