...
class InvItemsAssignedSearch extends InvItemsAssigned
{
    ...
    {
        return [
            [['id', 'inv_purchase_id', 'inv_purchase_item_id', 'status'], 'integer'],
