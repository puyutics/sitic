...
namespace app\models\siad_nivelacion;

use yii\base\Model;
use yii\data\ActiveDataProvider;
use app\models\siad_nivelacion\EstudiantesNivelacion;

/**
 * EstudiantesNivelacionSearch represents the model behind the search form of `app\models\siad_nivelacion\EstudiantesNivelacion`.
 */
class EstudiantesNivelacionSearch extends EstudiantesNivelacion
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = EstudiantesNivelacion::find();
