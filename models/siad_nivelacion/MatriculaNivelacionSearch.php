...
use app\models\siad_nivelacion\MatriculaNivelacion;

/**
 * MatriculaNivelacionSearch represents the model behind the search form of `app\models\siad_nivelacion\MatriculaNivelacion`.
 */
class MatriculaNivelacionSearch extends MatriculaNivelacion
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MatriculaNivelacion::find();
