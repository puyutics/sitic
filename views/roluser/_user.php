...
if (isset($username)) {
    ...
    $searchModelRolUser = new \app\models\RolUserSearch();
    $searchModelRolUser->username = $username;
    $dataProviderRolUser = $searchModelRolUser->search(Yii::$app->request->queryParams);

    $totalCount = $dataProviderRolUser->getTotalCount();
    ...
    <?php } else { ?>
        ...
        <div class="rol-user-index">
            ...
            <div id="ajaxCrudDatatable">
                <?=GridView::widget([
                    'id'=>'crud-datatable',
                    'dataProvider' => $dataProviderRolUser,
                    'filterModel' => $searchModelRolUser,
                    'pjax'=>true,
                    'columns' => [
