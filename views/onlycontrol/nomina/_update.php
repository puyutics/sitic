...
<div class="nomina-form">
    ...
    <?php //echo $form->field($model, 'NOMINA_SERV1')->textInput() ?>

    <?php //echo $form->field($model, 'NOMINA_SERV2')->textInput() ?>

    <?php //echo $form->field($model, 'NOMINA_SERV3')->textInput() ?>

    <?php //echo $form->field($model, 'NOMINA_SERV4')->textInput() ?>

    <?php //echo $form->field($model, 'NOMINA_SERV5')->textInput() ?>

    <?php //echo $form->field($model, 'NOMINA_SERV6')->textInput() ?>

    <?php //echo $form->field($model, 'NOMINA_SERV7')->textInput() ?>

    <?php //echo $form->field($model, 'NOMINA_SERV8')->textInput() ?>

    <?php //echo $form->field($model, 'NOMINA_SERV9')->textInput() ?>

    <?php //echo $form->field($model, 'NOMINA_CARDKEY')->textInput(['maxlength' => true]) ?>
    ...
    <?php //echo $form->field($model, 'NOMINA_FACE')->textInput() ?>

    <?php //echo $form->field($model, 'NOMINA_FACE_LEN')->textInput() ?>

    <?php //echo $form->field($model, 'B_MATCHER_FLAG')->textInput(['maxlength' => true]) ?>

    <?php //echo $form->field($model, 'NOMINA_P26')->textInput() ?>

    <?php //echo $form->field($model, 'NOMINA_KEY_CONSULT')->textInput(['maxlength' => true]) ?>

    <?php //echo $form->field($model, 'NOMINA_P27')->textInput() ?>

    <?php //echo $form->field($model, 'NOMINA_ADMIN_BIO')->textInput() ?>
