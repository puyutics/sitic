...
<div class="nomina-form">
    ...
    <?= $form->field($model, 'NOMINA_SERV1')->textInput() ?>

    <?= $form->field($model, 'NOMINA_SERV2')->textInput() ?>

    <?= $form->field($model, 'NOMINA_SERV3')->textInput() ?>

    <?= $form->field($model, 'NOMINA_SERV4')->textInput() ?>

    <?= $form->field($model, 'NOMINA_SERV5')->textInput() ?>

    <?= $form->field($model, 'NOMINA_SERV6')->textInput() ?>

    <?= $form->field($model, 'NOMINA_SERV7')->textInput() ?>

    <?= $form->field($model, 'NOMINA_SERV8')->textInput() ?>

    <?= $form->field($model, 'NOMINA_SERV9')->textInput() ?>

    <?= $form->field($model, 'NOMINA_CARDKEY')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'NOMINA_FACE')->textInput() ?>

    <?= $form->field($model, 'NOMINA_FACE_LEN')->textInput() ?>

    <?= $form->field($model, 'B_MATCHER_FLAG')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'NOMINA_P26')->textInput() ?>

    <?= $form->field($model, 'NOMINA_KEY_CONSULT')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'NOMINA_P27')->textInput() ?>

    <?= $form->field($model, 'NOMINA_ADMIN_BIO')->textInput() ?>
