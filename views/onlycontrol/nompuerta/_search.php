...
/* @var $model app\models\onlycontrol\NomPuertaSearch */
...
<div class="nom-puerta-search">
    ...
    <?php // echo $form->field($model, 'ES_SINCRONIZADO') ?>

    <?php // echo $form->field($model, 'ES_UPDATE') ?>

    <?php // echo $form->field($model, 'TURN_CONFSIMILAR') ?>
