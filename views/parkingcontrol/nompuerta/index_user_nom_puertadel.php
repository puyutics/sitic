...
$searchModelNomPuertaDel = new \app\models\parkingcontrol\NomPuertaDelSearch();
                ...
                'buttons'=>[
                    'access' => function ($url, $model) {
                        ...
                        return Html::a('<span class="btn btn-primary center-block">'.Icon::show('fingerprint') . 'Accesos'.'</span>',
                            Url::to(['parkingcontrol/asistnow/indexuser', 'oc_user_id'=>base64_encode($model->NOM_ID), 'oc_zona'=>base64_encode($puerta->PRI_IP)]),
