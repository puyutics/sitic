...
/* @var $searchModel app\models\sisges\TthhAsistenciaSearch */
...
<div class="tthh-asistencia-index">
    ...
    <?php
    $searchModelServidor = new \app\models\sisges\TthhServidorSearch();
    ...
    if ($dataProviderPermisos->getTotalCount()>0) {
        $searchModelPermisos = new \app\models\sisges\TthhAsistenciaSearch();
    } else {
        $searchModelPermisos = new \app\models\sisges\TthhAsistenciaDocSearch();
    }
