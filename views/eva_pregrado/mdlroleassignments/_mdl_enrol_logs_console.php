...
$folder = '/var/www/web_apps/sitic.uea.edu.ec/web/enrol/'.Yii::$app->params['course_code'].'/console_output/';
$url = 'https://www.uea.edu.ec/sitic/enrol/'.Yii::$app->params['course_code'].'/console_output/';
$arrFiles = array();
