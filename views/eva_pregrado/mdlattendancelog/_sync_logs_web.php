...
$folder = '/var/www/web_apps/sitic.uea.edu.ec/web/attendance/'.Yii::$app->params['course_code'].'/web_output/';
$url = 'https://www.uea.edu.ec/sitic/attendance/'.Yii::$app->params['course_code'].'/web_output/';
$arrFiles = array();
