...
$this->title = Yii::t('app', 'Procesos/Proyectos');
...
<div class="it-processes-projects-index">
    ...
    <p>
        <?php //= Html::a(Yii::t('app', 'Agregar relación'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
            ...
            [
                ...
                'editableOptions' => function() {
                    return [
                        ...
                        'size' => 'md',
                        'formOptions' => ['action' => Url::to(['itprocessesprojects/eitprocessesid'])],
                        'options' => [
