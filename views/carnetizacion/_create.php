...
if (strtotime(date("Y-m-d H:i:s",time())) > strtotime("2022-10-17 08:00:00")) {
    $system_status = true;
} else {
    $system_status = false;
}
...
<?php } else { ?>
    <div class="alert alert-danger" align="center">
        <h3 align="center">El sistema no disponible<br><br>Inténtelo nuevamente a partir de la primera semana de clases<br>(17/octubre/2022)</h3>
    </div>
<?php } ?>
