    ...
    <?php echo TabsX::widget([
        ...
        'items' => [
            ...
            [
                ...
                'content' => $this->render('../tabintformulario/_view_user', [
                    'model' => $model,
                ]),
            ],
            [
                'label'=>'<i class="glyphicon glyphicon-list-alt"></i> Estudiante SIAD',
                'content' => $this->render('../tabintformulario/_view_estudiante'),
            ],
            [
                'label'=>'<i class="glyphicon glyphicon-list-alt"></i> Matricula SIAD',
                'content' => $this->render('../tabintformulario/_index_matricula'),
            ],
            [
                'label'=>'<i class="glyphicon glyphicon-list-alt"></i> Ficha Estratificación',
                'content' => $this->render('../tabintformulario/_index_festrat'),
            ],
        ],
    ]);
    ?>
